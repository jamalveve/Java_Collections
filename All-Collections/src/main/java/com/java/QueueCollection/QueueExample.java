...
public class QueueExample {
	public static void main(String[] args) {
		...
		priqueue.add("dummy");
		priqueue.add("1");
		System.out.println(priqueue.hashCode());
		int hashcode1 = priqueue.hashCode();
		...
		int hashcode2 = priorityQueue.hashCode();
...
//if(hashcode2.e)
		...
		// IndexOf - Since PriorityQueue doesn't have this method natively, we will
